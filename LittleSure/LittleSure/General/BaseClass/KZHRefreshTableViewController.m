//
//  KZHRefreshTableViewController.m
//  LittleSure
//
...
#import "KZHRefreshTableViewController.h"

@interface KZHRefreshTableViewController ()

@property (nonatomic, readonly) UITableViewStyle style;

@end

@implementation KZHRefreshTableViewController
...
- (void)setShowRefreshHeader:(BOOL)showRefreshHeader
{
    if (_showRefreshHeader != showRefreshHeader) {
        ...
        if (_showRefreshHeader) {
            __weak KZHRefreshTableViewController *weakSelf = self;
