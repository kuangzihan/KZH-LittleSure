...
- (NSData *)bitmapData
{
    ...
    if(bitmapData) {
        ...
        for(int y = 0; (y + 24) < height; ) {
            ...
            //            m_imageData[result_index++] = 0x1B;
            //            m_imageData[result_index++] = 0x33;
            //            m_imageData[result_index++] = 0x00;
        ...
        //        Byte lineSpace1[] = {0x1B,0x33,0x00};
        //        [data appendBytes:lineSpace1 length:sizeof(lineSpace1)];
